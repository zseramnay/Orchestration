...
Découpe un gros fichier specenv en fichiers séparés par instrument.
...
Chaque fichier résultant commence par la ligne d'en-tête :
  specenv 4096 2048 1024

Usage :
  python split_spectrum_by_instrument.py INPUT_FILE [OUTPUT_DIR]

  INPUT_FILE : fichier specenv source (peut faire >200 MB)
        ...
        for line in f:
            ...
            if instrument:
                ...
                if instrument not in open_files:
                    out_path = output_dir / f"{instrument}_specenv.txt"
