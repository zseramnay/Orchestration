...
ANALYSIS = {
    'Saxophone alto': """Son chaud et expressif, grande flexibilité timbrale et dynamique.
        ...
        Le saxophone alto est le seul saxophone présent dans la base SOL2020 Orchidea.
...
<p><strong>Corpus disponible :</strong> saxophone alto uniquement (base SOL2020 Orchidea).
...
"""
    ...
    html += f'<p class="source-note"><strong>Source :</strong> formants_all_techniques.csv (SOL2020 Orchidea) · pipeline v22.<br/><strong>Références :</strong> Backus (1969) · Giesler (1985) · Meyer (2009).</p>\n'
    html += html_foot()
...
def build_docx(output_path):
    ...
    r.bold = True
    p.add_run("saxophone alto uniquement (SOL2020 Orchidea). "
...
if __name__ == '__main__':
    html_path = os.path.join(OUT_DIR, 'section_sax_v6.html')
    docx_path = os.path.join(OUT_DIR, 'section_sax_v6.docx')
