...
couleur homogène plutôt que deux voix distinctes. La fusion ne dépend
pas de l'unisson mélodique --- c'est une propriété du \emph{timbre}, pas
de la hauteur. Seuils mesurés : $\Delta = 0$ (unisson formantique),
$\Delta \leq 30$~Hz (fusion quasi-parfaite), $\Delta$ 30--80~Hz (fusion
efficace).
...
La clarinette en Sib et la flûte présentent des profils spectraux
fortement dépendants du registre, ce qui limite la portée des valeurs
F1 globales pour ces instruments. Par ailleurs, les données McCarty/CCRMA
présentent des limitations d'exactitude reconnues et doivent être
...
\url{https://zseramnay.github.io/Formants/}.
